...
/** Woechentliche Pflichtstunden je Schulform (Vollzeitdeputat) */
export const pflichtstunden = pgTable("pflichtstunden", {
  id: serial("id").primaryKey(),
  schulform: varchar("schulform", { length: 50 }).notNull().unique(),
  vollzeitDeputat: numeric("vollzeit_deputat", { precision: 4, scale: 1 }).notNull(),
...
export const berechnungStellensoll = pgTable("berechnung_stellensoll", {
  ...
  // Deputatsstundenrahmen gem. BASS 11-11 Nr. 1, § 2 Abs. 1, Tabelle 2
  vollzeitDeputat: numeric("vollzeit_deputat", { precision: 4, scale: 1 }),
  deputatstundenrahmen: numeric("deputatstundenrahmen", { precision: 8, scale: 1 }),
