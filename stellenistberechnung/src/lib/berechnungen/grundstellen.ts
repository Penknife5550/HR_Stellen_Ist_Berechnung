...
export function berechneGrundstellen(
  ...
  // KRITISCH: Ganzzahlige Summation um Floating-Point-Fehler zu vermeiden.
  // Beispiel: 24.58 + 7.87 ergibt in IEEE 754 = 32.449999... statt 32.45
  // Das wuerde bei roundToDecimals(32.449999, 1) zu 32.4 statt 32.5 fuehren.
  const summeTrunc = teilErgebnisse.reduce(
    (sum, te) => sum + Math.round(te.ergebnisTrunc * 100),
    0
  ) / 100;
